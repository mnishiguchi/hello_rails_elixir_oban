class CreateObanTables < ActiveRecord::Migration[8.0]
  def up
    ...
    create_table :oban_jobs, id: :bigserial, force: :cascade do |t|
      ...
      t.text :attempted_by, array: true, default: []
      ...
      t.datetime :inserted_at, null: false, default: -> { "CURRENT_TIMESTAMP" }
    ...
    create_table :oban_peers, primary_key: [:name], id: false do |t|
